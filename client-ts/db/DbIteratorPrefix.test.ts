...
describe("Db iterator prefix semantics", () => {
  it.effect("seek respects prefix and >= lower bound", () =>
    Effect.gen(function* () {
      ...
      assert.strictEqual(Bytes.equals(e0.key as any, k1), true);
      ...
      assert.strictEqual(Bytes.equals(e1.key as any, prefix), true);
      ...
      assert.strictEqual(Bytes.equals(e2.key as any, k2), true);
  ...
  it.effect("next respects prefix and strict > bound", () =>
    Effect.gen(function* () {
      ...
      assert.strictEqual(Bytes.equals(e1.key as any, k2), true);
      ...
      assert.strictEqual(Bytes.equals(e2.key as any, prefix), true);
  ...
  it.effect("range with prefix returns ordered subset or empty", () =>
    Effect.gen(function* () {
      ...
      assert.strictEqual(Bytes.equals(entries[0]!.key, k1), true);
      assert.strictEqual(Bytes.equals(entries[1]!.key, k2), true);
      assert.strictEqual(Bytes.equals(entries[2]!.key, prefix), true);
