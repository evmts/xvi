...
- Import from Voltaire: @import("voltaire"), @import("crypto") — NEVER create custom Address/Hash/u256 types
...
- Examples:
  - "♻️ refactor(phase-0-db): add RocksDB adapter with get/put/delete"
  - "🧪 test(phase-0-db): add unit tests for RocksDB adapter"
