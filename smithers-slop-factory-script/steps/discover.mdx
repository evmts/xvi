...
3. Read docs/test-suite-findings.md if it exists — this contains the status of external test suites, what's blocking them, and suggested tickets to unblock testing. Prioritize work that unblocks test suites.
4. Browse the codebase to understand what's already built
